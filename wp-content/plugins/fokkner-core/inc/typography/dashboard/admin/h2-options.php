...
if ( ! function_exists( 'fokkner_core_add_h2_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function fokkner_core_add_h2_typography_options( $page ) {
		...
		if ( $page ) {
			$h2_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h2',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H2 Typography', 'fokkner-core' ),
					'description' => esc_html__( 'Set values for Heading 2 HTML element', 'fokkner-core' ),
				)
			);
	...
	add_action( 'fokkner_core_action_after_typography_options_map', 'fokkner_core_add_h2_typography_options' );
}
