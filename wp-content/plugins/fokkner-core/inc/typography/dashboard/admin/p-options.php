...
if ( ! function_exists( 'fokkner_core_add_p_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function fokkner_core_add_p_typography_options( $page ) {
		...
		if ( $page ) {
			$paragraph_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-paragraph',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Paragraph Typography', 'fokkner-core' ),
					'description' => esc_html__( 'Set values for paragraph', 'fokkner-core' ),
				)
			);
	...
	add_action( 'fokkner_core_action_after_typography_options_map', 'fokkner_core_add_p_typography_options' );
}
