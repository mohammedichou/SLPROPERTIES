...
if ( ! function_exists( 'fokkner_core_add_product_list_variation_info_below' ) ) {
	/**
	 ...
	 * @return array
	 */
	function fokkner_core_add_product_list_variation_info_below( $variations ) {
		$variations['info-below'] = esc_html__( 'Info Below', 'fokkner-core' );

		return $variations;
	}

	add_filter( 'fokkner_core_filter_product_list_layouts', 'fokkner_core_add_product_list_variation_info_below' );
}

if ( ! function_exists( 'fokkner_core_register_shop_list_info_below_actions' ) ) {
	/**
	 * Function that override product item layout for current variation type
	 */
	function fokkner_core_register_shop_list_info_below_actions() {
	...
	add_action( 'fokkner_core_action_shop_list_item_layout_info-below', 'fokkner_core_register_shop_list_info_below_actions' );
}
