<?php
$property_list_image = get_post_meta( get_the_ID(), 'qodef_property_list_image', true );
$has_image           = ! empty( $property_list_image ) || has_post_thumbnail();
...
if ( $has_image ) {
	...
	<div class="qodef-e-media-image">
		<a itemprop="url" href="<?php the_permalink(); ?>">
			<?php echo fokkner_core_get_list_shortcode_item_image( $image_dimension, $property_list_image, $custom_image_width, $custom_image_height ); ?>
		</a>
	</div>
<?php } ?>
