...
if ( ! function_exists( 'fokkner_core_add_single_image_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function fokkner_core_add_single_image_shortcode( $shortcodes ) {
		$shortcodes[] = 'FokknerCore_Single_Image_Shortcode';

		return $shortcodes;
	}

	add_filter( 'fokkner_core_filter_register_shortcodes', 'fokkner_core_add_single_image_shortcode' );
}

if ( class_exists( 'FokknerCore_Shortcode' ) ) {
	class FokknerCore_Single_Image_Shortcode extends FokknerCore_Shortcode {

		public function __construct() {
			$this->set_layouts( apply_filters( 'fokkner_core_filter_single_image_layouts', array() ) );
			$this->set_extra_options( apply_filters( 'fokkner_core_filter_single_image_extra_options', array() ) );

			parent::__construct();
		}

		public function map_shortcode() {
			$this->set_shortcode_path( FOKKNER_CORE_SHORTCODES_URL_PATH . '/single-image' );
			$this->set_base( 'fokkner_core_single_image' );
			$this->set_name( esc_html__( 'Single Image', 'fokkner-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds image element', 'fokkner-core' ) );
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'fokkner_core_single_image', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return fokkner_core_get_template_part( 'shortcodes/single-image', 'variations/' . $atts['layout'] . '/templates/' . $atts['layout'], '', $atts );
		}
