...
if ( ! function_exists( 'fokkner_core_add_section_title_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function fokkner_core_add_section_title_shortcode( $shortcodes ) {
		$shortcodes[] = 'FokknerCore_Section_Title_Shortcode';

		return $shortcodes;
	}

	add_filter( 'fokkner_core_filter_register_shortcodes', 'fokkner_core_add_section_title_shortcode' );
}

if ( class_exists( 'FokknerCore_Shortcode' ) ) {
	class FokknerCore_Section_Title_Shortcode extends FokknerCore_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( FOKKNER_CORE_SHORTCODES_URL_PATH . '/section-title' );
			$this->set_base( 'fokkner_core_section_title' );
			$this->set_name( esc_html__( 'Section Title', 'fokkner-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds section title element', 'fokkner-core' ) );
			...
			$this->set_option(
				array(
					'field_type'    => 'select',
					'name'          => 'subtitle_tag',
					'title'         => esc_html__( 'Subitle Tag', 'fokkner-core' ),
					'options'       => fokkner_core_get_select_type_options_pool( 'title_tag' ),
					'default_value' => 'h5',
					'group'         => esc_html__( 'Subtitle Style', 'fokkner-core' ),
				)
			);
			$this->set_option(
				array(
			...
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'Subtitle Margin Top', 'fokkner-core' ),
					'group'      => esc_html__( 'Subtitle Style', 'fokkner-core' ),
				)
			);
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'link',
					'title'      => esc_html__( 'Title Custom Link', 'fokkner-core' ),
					'group'      => esc_html__( 'Title Style', 'fokkner-core' ),
				)
			);
			$this->set_option(
			...
			$this->set_option(
				array(
					...
					'group'      => esc_html__( 'Text Style', 'fokkner-core' ),
				)
			);
			$this->set_option(
				array(
		...
		public function render( $options, $content = null ) {
			...
			return fokkner_core_get_template_part( 'shortcodes/section-title', 'templates/section-title', '', $atts );
		}
