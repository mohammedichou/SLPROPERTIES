...
if ( ! function_exists( 'fokkner_core_nav_menu_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function fokkner_core_nav_menu_options( $page ) {
		...
		if ( $page ) {
			$main_menu_tab = $page->add_tab_element(
				array(
					...
					'icon'  => 'fa fa-cog',
					'title' => esc_html__( 'Main Menu Settings', 'fokkner-core' ),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Full Width', 'fokkner-core' ),
					'default_value' => 'yes',
				)
			);
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Content In Grid', 'fokkner-core' ),
					'default_value' => 'yes',
					'args'          => array(
						'col_width' => 6,
					),
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Main Menu Dropdown Appearance', 'fokkner-core' ),
					'default_value' => 'default',
					'options'       => array(
						'default'        => esc_html__( 'Default', 'fokkner-core' ),
						'animate-height' => esc_html__( 'Animate Height', 'fokkner-core' ),
					),
					'args'          => array(
						'col_width' => 6,
					),
			...
			$nav_menu_typography_section = $main_menu_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Main Menu Typography', 'fokkner-core' ),
				)
			);
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Left/Right', 'fokkner-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Padding Left/Right', 'fokkner-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$second_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Second Level Wide Typography', 'fokkner-core' ),
				)
			);
			...
			$third_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Third Level Wide Typography', 'fokkner-core' ),
				)
			);
	...
	add_action( 'fokkner_core_action_after_header_options_map', 'fokkner_core_nav_menu_options' );
}
