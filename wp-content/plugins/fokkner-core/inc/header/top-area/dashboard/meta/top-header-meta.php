<?php
if ( ! function_exists( 'fokkner_core_add_top_area_meta_options' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function fokkner_core_add_top_area_meta_options( $page ) {
	...
	add_action( 'fokkner_core_action_after_page_header_meta_map', 'fokkner_core_add_top_area_meta_options', 20 );
}
