...
if ( ! function_exists( 'fokkner_core_add_dripicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function fokkner_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'FokknerCore_Dripicons_Icon_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'fokkner_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class FokknerCore_Dripicons_Icon_Pack extends QodeFrameworkIconPack {
