...
if ( ! function_exists( 'fokkner_core_add_ionicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function fokkner_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'FokknerCore_IonIcons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'fokkner_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class FokknerCore_IonIcons_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return array(
				...
				'woo-back'      => 'ion-ios-arrow-back',
				'woo-forward'      => 'ion-ios-arrow-forward',
