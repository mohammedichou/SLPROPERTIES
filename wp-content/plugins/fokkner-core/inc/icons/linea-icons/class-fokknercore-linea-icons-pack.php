...
if ( ! function_exists( 'fokkner_core_add_linea_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function fokkner_core_add_linea_icons_to_collection( $icons ) {
		$icons[] = 'FokknerCore_Linea_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'fokkner_core_add_linea_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class FokknerCore_Linea_Icons_Pack extends QodeFrameworkIconPack {
